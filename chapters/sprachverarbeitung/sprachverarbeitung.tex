...
Uns liegen Kenntnisse (eigentlich Annahmen, s.u.) über frühere Zuständen zu jedem Zeitpunkt t–k (0 < k <= t) vor, aus denen wir die Wahrscheinlichkeit für das Eintreten von Xt in einem Übergangsmodell erhalten.
